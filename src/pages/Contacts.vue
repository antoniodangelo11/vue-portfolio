...
<template>
  ...
  <section class="m-5 p-4 dark:text-gray-50">
    <div class="p-5 text-gray-100">
      ...
      <form @submit.prevent="sendLead" novalidate class="container flex flex-col mx-auto space-y-12">

        <fieldset class="bg-slate-600 grid grid-cols-4 gap-4 p-6 rounded-md shadow-sm dark:bg-gray-900">
          <h1 class="text-3xl font-bold mx-5">Contact Us</h1>
        </fieldset>


        <fieldset class="bg-slate-600 py-10 grid grid-cols-4 gap-4 px-6 rounded-md shadow-sm dark:bg-gray-900">
          ...
          <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-6">
            <div class="col-span-full sm:col-span-6">
              ...
              <input type="email" class="form-input mt-1 block w-full rounded-md border-gray-300" id="email"
                v-model="email">
            </div>
          ...
          <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-6">
            <div class="col-span-full sm:col-span-6">
              ...
              <textarea id="message" class="form-textarea mt-1 block w-full rounded-md border-gray-300" rows="5"
          ...
          <div>
            ...
            <label class="ml-2 text-sm text-gray-100" for="newsletter">Subscribe to newsletter</label>
          </div>
        </fieldset>

        <div class="bg-slate-600 py-4 flex justify-center rounded-md shadow-sm dark:bg-gray-900">
          <button type="submit" class="px-4 py-2 border rounded-md dark:border-gray-100"
